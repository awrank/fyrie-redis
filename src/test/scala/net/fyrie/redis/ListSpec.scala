...
class ListSpec extends mutable.Specification with TestClient {
  ...
  "lpush" >> {
    "should add to the head of the list" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "foo") === (1)
      r.sync.lpush("list-1", "bar") === (2)
    }
    "should throw if the key has a non-list value" ! client { r: RedisClient ⇒
  ...
  "llen" >> {
    "should return the length of the list" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "foo") === (1)
      r.sync.lpush("list-1", "bar") === (2)
      r.sync.llen("list-1") === (2)
    }
    "should return 0 for a non-existent key" ! client { r: RedisClient ⇒
      r.sync.llen("list-2") === (0)
    }
    "should throw for a non-list key" ! client { r: RedisClient ⇒
      r.set("anshin-1", "debasish")
  ...
  "lrange" >> {
    "should return the range" ! client { r: RedisClient ⇒
    ...
    "should return empty list if start > end" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "3") === (1)
      r.sync.lpush("list-1", "2") === (2)
      r.sync.lpush("list-1", "1") === (3)
      r.sync.lrange("list-1", 2, 0).parse[String] === (Some(Nil))
    }
    "should treat as end of list if end is over the actual end of list" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "3") === (1)
      r.sync.lpush("list-1", "2") === (2)
      r.sync.lpush("list-1", "1") === (3)
  ...
  "ltrim" >> {
    "should trim to the input size" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "5") === (2)
      r.sync.lpush("list-1", "4") === (3)
      r.sync.lpush("list-1", "3") === (4)
    ...
    "should should return empty list for start > end" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "5") === (2)
      r.sync.lpush("list-1", "4") === (3)
      r.ltrim("list-1", 6, 3)
  ...
  "lindex" >> {
    "should return the value at index" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "5") === (2)
      r.sync.lpush("list-1", "4") === (3)
      r.sync.lpush("list-1", "3") === (4)
    ...
    "should return None if the key does not point to a list" ! client { r: RedisClient ⇒
      r.set("anshin-1", "debasish")
      r.sync.lindex("list-1", 0).parse[String] === (None)
    }
    "should return empty string for an index out of range" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "5") === (2)
      r.sync.lpush("list-1", "4") === (3)
  ...
  "lset" >> {
    "should set value for key at index" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "5") === (2)
      r.sync.lpush("list-1", "4") === (3)
      r.sync.lpush("list-1", "3") === (4)
    ...
    "should generate error for out of range index" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "5") === (2)
      r.sync.lpush("list-1", "4") === (3)
  ...
  "lrem" >> {
    "should remove count elements matching value from beginning" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
    ...
    "should remove all elements matching value from beginning" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "hello") === (2)
      r.sync.lpush("list-1", "4") === (3)
      r.sync.lpush("list-1", "hello") === (4)
    ...
    "should remove count elements matching value from end" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "hello") === (2)
      r.sync.lpush("list-1", "4") === (3)
      r.sync.lpush("list-1", "hello") === (4)
  ...
  "lpop" >> {
    "should pop the first one from head" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "5") === (2)
      r.sync.lpush("list-1", "4") === (3)
      r.sync.lpush("list-1", "3") === (4)
    ...
    "should give nil for non-existent key" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "5") === (2)
  ...
  "rpop" >> {
    "should pop the first one from tail" ! client { r: RedisClient ⇒
      r.sync.lpush("list-1", "6") === (1)
      r.sync.lpush("list-1", "5") === (2)
      r.sync.lpush("list-1", "4") === (3)
      r.sync.lpush("list-1", "3") === (4)
  ...
  "rpoplpush" >> {
    "should do" ! client { r: RedisClient ⇒
    ...
    "should rotate the list when src and dest are the same" ! client { r: RedisClient ⇒
      r.sync.rpush("list-1", "a") === (1)
      r.sync.rpush("list-1", "b") === (2)
      r.sync.rpush("list-1", "c") === (3)
    ...
    "should give None for non-existent key" ! client { r: RedisClient ⇒
